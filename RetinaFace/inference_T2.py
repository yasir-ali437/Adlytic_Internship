...
dataset_path = "/home/adlytic/Yasir Adlytic/Adlytic_Internship/Face Recognition/Driver_Faces_Updated_New/"
    ...
    for face in faces:
        ...
        if best_score > threshold:
            ...
            if drivers_facepics_count < 50:
                ...
                training.create_driver_embeddings(dataset_path="../Face Recognition/Driver_Faces_Updated_New")
            else:
                continue
        else:
            name = "Unknown"
...
parentFolder = "/home/adlytic/Yasir Adlytic/Adlytic_Internship/Alerts/"
                    ...
                    for alert_folder in os.listdir(date_path):
                        ...
                        if os.path.isdir(alert_folder_path):
                            ...
                            if alerts!=[]:
                                ...
                                frame_list = select_best_frame(alert_path)
                                if frame_list:
                                    recognize_face(alert_folder, date, sheet, frame_list, "best_frame.jpg")
            else:
