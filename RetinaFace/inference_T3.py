...
def recognize_face(alert_folder, date, sheet, frame_faces_list, img_path, threshold=0.45):
    frame_list = frame_faces_list[0]
    faces_list = frame_faces_list[1]
